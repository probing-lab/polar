...
class VarianceBasedTerminationAnalyzer:
    ...
    def compute_bound(self, exact):
        ...
        witness = estimate_bound_exponent_inductive_bound_genetic(self.p1,MinMaxQuadraticAlgorithmConfig(600, 100, 400, 20, 200, 5,2, degree_pop=1, degree_gran=1), q1, q2,initial_expr=self.initial_value, exact_n0=exact)
