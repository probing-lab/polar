...
def estimate_bound_percentage_of_terminating_union_bound(self,m, C, delta1, delta2, epsilon, c_0, n_0):
    ...
    for k in np.linspace(pow(6.87, 1/(2*m+1)), 20, 1000):
        for t in np.linspace(2,30, 100):
            perc = 1-self._calculate_percentage_of_terminating(t,pow(k,(2*m+1)),C,delta1,delta2,c_0)
