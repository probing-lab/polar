...
class TerminationAnalyzer:
    @classmethod
    def analyze(cls, normalized_program: Program, loop_guard: Condition, smt=False, amber=False, variance_based=False, exact=False, genetic_algorithm_config=None, seed=None):
        print()
        print(colored("-------------------", "cyan"))
