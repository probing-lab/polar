...
parser = argparse.ArgumentParser(description="Reproduce Figure 1 with weak assumptions (top part of Table 1)")
...
moment_bound_using_ost(
            ...
            [(Symbol("x0", is_finite=True, real=True, positive=True),sympify(0), oo), 
            (Symbol("y0", is_finite=True, real=True),-oo, oo),
            (Symbol("z0", is_finite=True, real=True),-oo, oo)],
