...
correct_network: BayesNetwork = BayesNetwork(
    "unknown", ["version 2.0", "author ProbingLab"], 0.001
)

asia_visit: BayesVariable = BayesVariable(
    "asia_visit", ("has-visited", "no-visit"), ["this-is-a-property"]
)
asia_visit.parents = ()
