...
class GoalsAction(Action):
    ...
    def print_cumulant_goal(self, number, monom, cumulant, is_exact, prefix=""):
        ...
        if self.cli_args.at_n >= 0:
            ...
            print(f"{prefix}k{number}({monom} | n={self.cli_args.at_n}) = {cumulant_at_n} ≅ {N(cumulant_at_n)}")
        print()
    ...
    def print_central_moment_goal(self, number, monom, central_moment, is_exact, prefix=""):
        ...
        if self.cli_args.at_n >= 0:
            ...
            print(f"{prefix}c{number}({monom} | n={self.cli_args.at_n}) = {central_at_n} ≅ {N(central_at_n)}")
        print()
