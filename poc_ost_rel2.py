...
program = Parser().parse_file("documentation/loops_ost_extension/related_work_2.prob")
...
for var in normalized_program.variables:
...
compute_bounds(random_vars,
               ...
               2,
               recurrence_builder,
               [(Symbol("x0", is_finite=True, positive=True),sympify(0), sympify(100))],
