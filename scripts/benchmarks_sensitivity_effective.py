...
benchmarks = [
    Benchmark("../benchmarks/sensitivity/all_effective/50coinflips.prob", ["E(total)"], "p"),
    Benchmark("../benchmarks/sensitivity/all_effective/50coinflips.prob", ["E(total**2)"], "p"),
    Benchmark("../benchmarks/sensitivity/all_effective/50coinflips.prob", ["E(total**3)"], "p"),
    Benchmark("../benchmarks/sensitivity/all_effective/bimodal_x.prob", ["E(x)"], "p"),
    Benchmark("../benchmarks/sensitivity/all_effective/bimodal_x.prob", ["E(x**2)"], "p"),
    Benchmark("../benchmarks/sensitivity/all_effective/bimodal_x.prob", ["E(x**3)"], "p"),
    ...
    Benchmark("../benchmarks/sensitivity/all_effective/bimodal_x.prob", ["E(x**3)"], "var"),
    ...
    Benchmark("../benchmarks/sensitivity/all_effective/dbn_component_health.prob", ["E(obs**3)"], "p1"),
    Benchmark("../benchmarks/sensitivity/all_effective/dbn_umbrella.prob", ["E(umbrella)"], "u1"),
    Benchmark("../benchmarks/sensitivity/all_effective/dbn_umbrella.prob", ["E(umbrella**2)"], "u1"),
    Benchmark("../benchmarks/sensitivity/all_effective/dbn_umbrella.prob", ["E(umbrella**3)"], "u1"),
    ...
    Benchmark("../benchmarks/sensitivity/all_effective/gambling.prob", ["E(money**3)"], "p"),
    Benchmark("../benchmarks/sensitivity/all_effective/hawk_dove.prob", ["E(p1bal)"], "v"),
    Benchmark("../benchmarks/sensitivity/all_effective/hawk_dove.prob", ["E(p1bal**2)"], "v"),
    Benchmark("../benchmarks/sensitivity/all_effective/hawk_dove.prob", ["E(p1bal**3)"], "v"),
    ...
    Benchmark("../benchmarks/sensitivity/all_effective/las_vegas_search.prob", ["E(attempts**3)"], "p"),
    Benchmark("../benchmarks/sensitivity/all_effective/random_walk_1d.prob", ["E(x)"], "p"),
    Benchmark("../benchmarks/sensitivity/all_effective/random_walk_1d.prob", ["E(x**2)"], "p"),
    Benchmark("../benchmarks/sensitivity/all_effective/random_walk_1d.prob", ["E(x**3)"], "p"),
    Benchmark("../benchmarks/sensitivity/all_effective/random_walk_2d.prob", ["E(x)"], "p_right"),
    Benchmark("../benchmarks/sensitivity/all_effective/random_walk_2d.prob", ["E(x**2)"], "p_right"),
    Benchmark("../benchmarks/sensitivity/all_effective/random_walk_2d.prob", ["E(x**3)"], "p_right"),
    ...
    Benchmark("../benchmarks/sensitivity/all_effective/randomized_response.prob", ["E(p1**3)"], "p"),
    Benchmark("../benchmarks/sensitivity/all_effective/rock_paper_scissors.prob", ["E(p1bal)"], "p1"),
    Benchmark("../benchmarks/sensitivity/all_effective/rock_paper_scissors.prob", ["E(p1bal**2)"], "p1"),
    Benchmark("../benchmarks/sensitivity/all_effective/rock_paper_scissors.prob", ["E(p1bal**3)"], "p1"),
    ...
    Benchmark("../benchmarks/sensitivity/all_effective/vaccination.prob", ["E(infected**3)"], "vax_param"),
    ]
